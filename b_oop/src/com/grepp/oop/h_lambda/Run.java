...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        Exam kor = new Exam("국어", "정기문", 80);
        Exam math = new Exam("수학", "정기문", 80);

        System.out.println("국어시험 통과했니?");
        System.out.println(kor.isPass(exam -> exam.getScore() >= 75));
        System.out.println("수학시험 통과했니?");
        System.out.println(math.isPass(exam -> exam.getScore() >= 85));

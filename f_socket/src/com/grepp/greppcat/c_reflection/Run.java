...
import java.lang.reflect.InvogreppcationTargetException;
...
public class Run {
    ...
    private static void studyMethodInfo()
        throws NoSuchMethodException, InvogreppcationTargetException, InstantiationException, IllegalAccessException {
    ...
    private static void studyClassInfo()
        throws NoSuchMethodException, InvogreppcationTargetException, InstantiationException, IllegalAccessException, NoSuchFieldException {
        Class<Rectangle> rectangleClass = Rectangle.class;
